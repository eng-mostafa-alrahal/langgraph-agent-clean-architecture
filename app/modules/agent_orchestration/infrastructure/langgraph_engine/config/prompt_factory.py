...
RESEARCHER_SYSTEM_PROMPT = (
    ...
    "Strategy:\n"
    "1. If the user asks about recent events, sports scores, news, 'yesterday', 'today', "
    "or anything time-sensitive, call web_search first (and you may add rag_search if "
    "internal docs might help).\n"
    "2. If the question is only about internal policies or uploaded material, use rag_search.\n"
    "3. You may call multiple tools in one turn.\n"
    "4. Once you have enough context, stop calling tools so the results can be "
